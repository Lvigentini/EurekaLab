...
class SkillRegistry:
    ...
    def _seed_stats_path(self) -> Path:
        ...
        return settings.eurekalab_dir / "seed_skill_stats.json"
    ...
    def _load(self) -> None:
        ...
        #             self._load_file(path, is_seed=True, seed_stats=seed_stats)
        # 3. User skills from ~/.eurekalab/skills/ (highest priority)
