"""eurekalab onboard — interactive .env configuration wizard."""
...
def run_onboard(non_interactive: bool, reset: bool, env_file: str) -> None:
    ...
    # ── Welcome ───────────────────────────────────────────────────────────────
    console.print()
    console.print(Rule("[bold cyan]EurekaLab Onboarding[/bold cyan]"))
    console.print(
    ...
    console.print(
        ...
        "  Next steps:\n"
        "    [bold]eurekalab prove[/bold] \"Your conjecture here\"\n"
        "    [bold]eurekalab explore[/bold] \"A research domain\"\n"
    )
