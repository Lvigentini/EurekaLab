...
class ProofPausedException(Exception):
    ...
    a subsequent ``eurekalab resume <session_id>`` can continue from the
    ...
    def __init__(self, session_id: str, stage_name: str) -> None:
        ...
        super().__init__(
            ...
            f"Resume with: eurekalab resume {session_id}"
        )
...
class ProofCheckpoint:
    ...
    def __init__(self, session_id: str) -> None:
        self.session_id = session_id
        self._dir = settings.eurekalab_dir / "runs" / session_id
