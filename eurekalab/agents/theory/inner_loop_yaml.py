...
from eurekalab.agents.theory.analysis_stages import (
...
from eurekalab.agents.theory.gap_analyst import GapAnalyst
from eurekalab.agents.theory.key_lemma_extractor import KeyLemmaExtractor
from eurekalab.agents.theory.paper_reader import PaperReader
from eurekalab.agents.theory.proof_architect import ProofArchitect
...
class TheoryInnerLoopYaml:
    ...
    async def run(self, session_id: str, domain: str = "") -> TheoryState:
        ...
        Pause:
            Touch  ~/.eurekalab/sessions/<session_id>/pause.flag
