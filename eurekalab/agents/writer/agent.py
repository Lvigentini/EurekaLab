...
%% Header: EurekaLab logo on the first page
...
You are the Writer Agent of EurekaLab. You generate complete, publication-quality LaTeX papers \
...
You are the Writer Agent of EurekaLab. You generate complete, publication-quality Markdown papers \
from structured research artifacts.
