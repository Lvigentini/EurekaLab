...
from eurekalab.types.tasks import InputSpec, ResearchOutput

logger = logging.getLogger(__name__)


class EurekaSession:
    """A complete EurekaLab research session.
...
def _copy_template_assets(out_dir: Path) -> None:
    ...
    compilation.  The template directory lives at eurekalab/eurekatemplate/.
    """
    import shutil
